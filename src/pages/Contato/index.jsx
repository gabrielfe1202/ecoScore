...
export default function Contato(){
    return( 
        <>
            <section className="flex flex-row justify-center items-center min-h-[70vh] py-24 flex-wrap gap-11">
                <div className="flex justify-end md:pr-20">
                    <img src={contatoImage} className='w-full max-w-[50vh] rounded-3xl shadow-custom' />
                </div>
                <form className="bg-[#04253D] rounded-3xl w-11/12 md:w-5/12 flex flex-col gap-7 px-7 py-24 shadow-custom">
