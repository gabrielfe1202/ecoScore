...
export default function Footer() {
    return (
        <footer>
            <div className="bg-[#04253D] flex flex-row py-10 justify-center flex-wrap gap-10">
                ...
                <div className="w-full md:w-4/12 flex justify-center items-center">
                    <img src={logo} className="h-[70px] md:h-[100px]" />
                </div>
                <div className="w-full md:w-3/12 flex gap-7 justify-center items-center">
